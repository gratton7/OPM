...
function  varargout = shydc20ls( action, varargin )

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   A (slightly) simplified version of the hydrocarbon-20 problem by Fletcher,
%   where the vector fl has been set to zero.
%
...
%   OPM input (and simplification): Ph. Toint 30 VII 2021.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   end
   ...
   if ( iel <= mm )                 % 2.1-(j)
      ...
      switch( nargout )
      case 1
         fe11j = shydc20ls(    '2prod', x(ie11), pe11 );
         fe12j = shydc20ls( 'exp3prod', x(ie12), pe12 );
         riel  = bb*x(1) + fe11j + fe12j;
         varargout{1} = 0.0001*riel^2;
      case 2
         Jiel  = zeros( niel, 1 );
         [ fe11j, ge11j ] = shydc20ls(    '2prod', x(ie11), pe11 );
         [ fe12j, ge12j ] = shydc20ls( 'exp3prod', x(ie12), pe12 );
         riel         = bb*x(1) + fe11j + fe12j;
         varargout{1} = 0.0001*riel^2;
	 Jiel(1)      = Jiel(1) + bb;
	 ...
	 Hiel    = zeros( niel, niel );
         [ fe11j, ge11j, He11j ] = shydc20ls(    '2prod', x(ie11), pe11 );
         [ fe12j, ge12j, He12j ] = shydc20ls( 'exp3prod', x(ie12), pe12 );
         riel            = bb*x(1) + fe11j + fe12j;
         varargout{1}    = 0.0001*riel^2;
	 Jiel(1)         = Jiel(1) + bb;
	 Jiel(ie11)      = Jiel(ie11) + ge11j;
   ...
   elseif ( iel <= mm+mm )
      ...
      switch( nargout )
      case 1
         fe31j = shydc20ls( 'exp2prod', x(ie31), pe31 );
	 riel  = -x(2) + fe31j;
	 varargout{1} = riel^2;
      case 2
         Jiel  = zeros( niel, 1 );
         [ fe31j, ge31j ] = shydc20ls( 'exp2prod', x(ie31), pe31 );
	 riel         = -x(2) + fe31j;
	 varargout{1} = riel^2;
	 Jiel(2)      = Jiel(2) - 1;
	 ...
	 varargout{2} = 2*Jiel*riel;
      case 3
         Jiel  = zeros( niel, 1 );
         Hiel  = zeros( niel, niel );
         [ fe31j, ge31j, He31j ] = shydc20ls( 'exp2prod', x(ie31), pe31 );
	 riel            = -x(2) + fe31j;
	 varargout{1}    = riel^2;
	 Jiel(2)         = Jiel(2) - 1;
	 Jiel(ie31)      = Jiel(ie31) + ge31j;
...
%      end
      ...
      switch( nargout )
      case 1
         fe21j = shydc20ls(    '2prod', x(ie21), pe21 );
         fe22j = shydc20ls( 'exp3prod', x(ie22), pe22 );
         fe23j = shydc20ls(    '2prod', x(ie23), pe23 );
         fe24j = shydc20ls( 'exp3prod', x(ie24), pe24 );
	 riel  = riel + fe21j + fe22j + fe23j + fe24j;
	 varargout{1} = 0.0001*riel^2;
      case 2
         Jiel = zeros( niel, 1 );
         [ fe21j, ge21j ] = shydc20ls(    '2prod', x(ie21), pe21 );
         [ fe22j, ge22j ] = shydc20ls( 'exp3prod', x(ie22), pe22 );
         [ fe23j, ge23j ] = shydc20ls(    '2prod', x(ie23), pe23 );
         [ fe24j, ge24j ] = shydc20ls( 'exp3prod', x(ie24), pe24 );
	 riel         = riel + fe21j + fe22j + fe23j + fe24j;
	 varargout{1} = 0.0001*riel^2;
	 ...
	 varargout{2} = 0.0002*Jiel*riel;
      case 3
         Jiel = zeros( niel, 1 );
	 Hiel = zeros( niel, niel );
         [ fe21j, ge21j, He21j ] = shydc20ls(    '2prod', x(ie21), pe21 );
         [ fe22j, ge22j, He22j ] = shydc20ls( 'exp3prod', x(ie22), pe22 );
         [ fe23j, ge23j, He23j ] = shydc20ls(    '2prod', x(ie23), pe23 );
         [ fe24j, ge24j, He24j ] = shydc20ls( 'exp3prod', x(ie24), pe24 );
	 riel         = riel + fe21j + fe22j + fe23j + fe24j;
	 varargout{1} = 0.0001*riel^2;
         Jiel(ie21)   = Jiel(ie21) + ge21j;
         Jiel(ie22)   = Jiel(ie22) + ge22j;
...
%i = iel-mm*nn;
	 ...
	 for j = 1:mm
	    ie71 = [ j 4 ];
            ...
            fe71j = shydc20ls( 'exp2prod', x(ie71), pe71 );
	    riel  = riel + fe71j;
	 end
	 varargout{1} = riel^2;
      case 2
	 ...
	 for j = 1:mm
	    ie71 = [ j 4 ];
            pe71 = [ 1 1 a(j) b(j) c(j) ];
            [ fe71j, ge71j ] = shydc20ls( 'exp2prod', x(ie71), pe71 );
	    riel       = riel + fe71j;
	 ...
	 varargout{2} = 2*Jiel*riel;
      case 3
	    ...
	    ie71 = [ j 4 ];
            pe71 = [ 1 1 a(j) b(j) c(j) ];
            [ fe71j, ge71j, He71j ] = shydc20ls( 'exp2prod', x(ie71), pe71 );
	    riel            = riel + fe71j;
  	    Jiel(ie71)      = Jiel(ie71) + ge71j;
   ...
   elseif ( iel == (mm+1)*nn+1 )
	 ...
	 for j = 1:mm
	    ...
	    pe83 = [ -1 bb  0    0    0   al(j) al1(j) al2(j) ];
            fe81j = shydc20ls( 'exp4prod', x(ie81), pe81 );
            fe82j = shydc20ls( 'poly1prd', x(ie82), pe82 );
            fe83j = shydc20ls( 'poly2prd', x(ie83), pe83 );
	 ...
	 for j = 1:mm
	    ...
	    pe82 = [ bb  0  0    0    0   al(j) al1(j) al2(j) ];
	    pe83 = [ -1 bb  0    0    0   al(j) al1(j) al2(j) ];
            [ fe81j, ge81j ] = shydc20ls( 'exp4prod', x(ie81), pe81 );
            [ fe82j, ge82j ] = shydc20ls( 'poly1prd', x(ie82), pe82 );
            [ fe83j, ge83j ] = shydc20ls( 'poly2prd', x(ie83), pe83 );
	    riel = riel + fe81j + fe82j + fe83j;
	 ...
	 for j = 1:mm
	    ...
	    pe82 = [ bb  0  0    0    0   al(j) al1(j) al2(j) ];
	    pe83 = [ -1 bb  0    0    0   al(j) al1(j) al2(j) ];
            [ fe81j, ge81j, He81j ] = shydc20ls( 'exp4prod', x(ie81), pe81 );
            [ fe82j, ge82j, He82j ] = shydc20ls( 'poly1prd', x(ie82), pe82 );
            [ fe83j, ge83j, He83j ] = shydc20ls( 'poly2prd', x(ie83), pe83 );
	    riel = riel + fe81j + fe82j + fe83j;
	    Jiel(ie81) = Jiel(ie81) +ge81j;
	    Jiel(ie82) = Jiel(ie82) +ge82j;
	    Jiel(ie83) = Jiel(ie83) +ge83j;
	 ...
	 elseif ( i == kk+1 )
	    ...
	    pe93 = [ -1 1 a(j) b(j) c(j) be(j) be1(j) be2(j) ];
            fe91j = shydc20ls( 'exp4prod', x(ie91), pe91 );
            fe92j = shydc20ls( 'poly2prd', x(ie92), pe92 );
            fe93j = shydc20ls( 'exp4prod', x(ie93), pe93 );
            fe94j = shydc20ls( 'poly2prd', x(ie94), pe94 );
      ...
      case 2
	    ...
	    pe94 = [ -1 0  0    0    0   al(j) al1(j) al2(j) ];
            [ fe91j, ge91j ] = shydc20ls( 'exp4prod', x(ie91), pe91 );
            [ fe92j, ge92j ] = shydc20ls( 'poly2prd', x(ie92), pe92 );
            [ fe93j, ge93j ] = shydc20ls( 'exp4prod', x(ie93), pe93 );
            [ fe94j, ge94j ] = shydc20ls( 'poly2prd', x(ie94), pe94 );
	    riel = riel + fe91j + fe92j + fe93j + fe94j;
	 ...
	 varargout{2} = 2.e-10*Jiel*riel;
      case 3
	    ...
	    pe93 = [ -1 1 a(j) b(j) c(j) be(j) be1(j) be2(j) ];
	    pe94 = [ -1 0  0    0    0   al(j) al1(j) al2(j) ];
            [ fe91j, ge91j, He91j ] = shydc20ls( 'exp4prod', x(ie91), pe91 );
            [ fe92j, ge92j, He92j ] = shydc20ls( 'poly2prd', x(ie92), pe92 );
            [ fe93j, ge93j, He93j ] = shydc20ls( 'exp4prod', x(ie93), pe93 );
            [ fe94j, ge94j, He94j ] = shydc20ls( 'poly2prd', x(ie94), pe94 );
	    riel = riel + fe91j + fe92j + fe93j + fe94j;
	    Jiel(ie91) = Jiel(ie91) + ge91j;
	    Jiel(ie92) = Jiel(ie92) + ge92j;
	    Jiel(ie93) = Jiel(ie93) + ge93j;
