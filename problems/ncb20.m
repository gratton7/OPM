...
function  varargout = ncb20( action, varargin )

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   A hard banded problem with semi-bandwidth 20.  This problem exhibits
%   frequent negative curvature in the exact Hessian.
%
%   Source:
...
case 'setup' % varargout = [ x0, fstar, xtype, xlower, xupper, clower, cupper, class, error ]
   ...
   if ( length( varargin ) )
      n = varargin{1};
      if ( n < p+ny )
         disp( [ ' ERROR in ncb20: n = ', int2str(n), ' is less than ', num2str(p+ny),'!' ] )
	 return
      end
   else
      n = p+ny;
